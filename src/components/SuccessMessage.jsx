function SuccessMessage({ onBackToHome,onViewDashboard, streak = 1 }) {
  const getStreakMessage = (days) => {
    ...
    if (days < 7)
      return `Amazing! ${days} days in a row! You're building momentum! 🚀`;
    if (days < 30)
      return `Incredible! ${days} day streak! You're developing a solid habit! 🔥`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-lg w-full text-center">
        ...
        <div className="mb-6">
          <div
            className={`w-24 h-24 bg-gradient-to-r ${achievement.color} rounded-full flex items-center justify-center mx-auto mb-4 animate-bounce`}
          >
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-medium py-3 px-6 rounded-lg transition duration-300"
          >
            📊 View Dashboard
          </button>
