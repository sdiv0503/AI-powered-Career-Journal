...
function JournalForm({ onBackToHome }) {
  ...
  const activityOptions = [
    ...
    { label: '📚 Learning', value: 'learning', color: 'bg-green-100 text-green-800' },
    { label: '🐛 Debugging', value: 'debugging', color: 'bg-red-100 text-red-800' },
    { label: '📖 Reading', value: 'reading', color: 'bg-purple-100 text-purple-800' },
    { label: '🎥 Tutorial', value: 'tutorial', color: 'bg-yellow-100 text-yellow-800' },
    { label: '🤝 Collaboration', value: 'collaboration', color: 'bg-indigo-100 text-indigo-800' }
  ];

  // Popular technologies for autocomplete
  const popularTechs = [
    'React', 'JavaScript', 'Python', 'Node.js', 'TypeScript', 'HTML', 'CSS', 
    'Tailwind CSS', 'MongoDB', 'Express', 'Git', 'Docker', 'AWS', 'Next.js', 
    'Vue.js', 'Angular', 'Java', 'C++', 'SQL', 'PostgreSQL', 'Redis', 'GraphQL'
  ];
  ...
  const reflectionPrompts = [
    ...
    { id: 'collaboration', question: 'How did I help or learn from others today?' },
    { id: 'creativity', question: 'What creative solution did I come up with?' },
  ...
  // ✅ FIXED: Navigation functions with proper event prevention
  const nextStep = (e) => {
  ...
  if (showSuccess) {
    return <SuccessMessage onBackToHome={onBackToHome} streak={streak + 1} />;
  }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <form onSubmit={handleSubmit}>
            ...
            {currentStep === 2 && (
              <div className="p-8 space-y-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">What did you work on?</h2>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {activityOptions.map((activity) => (
                      <button
                        key={activity.value}
                        type="button"
                        onClick={() => handleArrayToggle('activities', activity.value)}
                      ...
                      >
                        <div className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${activity.color}`}>
                          {activity.label}
                        </div>
                      </button>
                    ))}
            ...
            {currentStep === 3 && (
              <div className="p-8 space-y-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Reflect on your progress</h2>
                ...
                <div>
                  ...
                  {formData.quickWins.map((win, index) => (
                    <input
                      ...
                      type="text"
                      value={win}
                      onChange={(e) => handleQuickWinChange(index, e.target.value)}
                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border border-purple-200">
                  ...
                  <textarea
                    ...
                    onChange={(e) => handleInputChange('reflectionAnswers', {
            ...
            {currentStep === 4 && (
              <div className="p-8 space-y-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Challenges, learnings & code</h2>
